...
<body>
    ...
    <div class="container">
        ...
        <form class="row" action="<?php echo URL_PROYECTO ?>/libroController/editarLibro/<?php echo $data['id']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="col-12 mb-3">
                <img src="<?php echo URL_PROYECTO; ?>/public/imagenesPortada/<?php echo $data['imagenPortada']?>" width="70">
            ...
            <div class="mb-3 text-center">
                <button type="button" class="btn btn-danger me-4" onclick="location.href='<?php echo URL_PROYECTO; ?>/libroController'">Cancelar</button>
