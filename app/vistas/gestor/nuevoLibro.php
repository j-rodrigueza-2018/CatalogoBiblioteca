...
<body>
    ...
    <div class="container">
        ...
        <form class="row" action="<?php echo RUTA_PUBLIC ?>/libroController/crearLibro" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="mb-3 text-center">
                <button type="button" class="btn btn-danger me-4"
                        onclick="location.href='<?php echo RUTA_PUBLIC; ?>/libroController'">Cancelar
                </button>
