...
$consulta = $conexion->query("SELECT c.*, l.id AS idLibro, l.titulo, l.imagenPortada FROM catalogo c JOIN libro l ON (c.libroId = l.id) WHERE c.destacado = 1 ORDER BY l.titulo");
