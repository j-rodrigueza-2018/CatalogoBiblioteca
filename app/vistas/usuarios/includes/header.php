    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a id="portada" class="nav-link" aria-current="page" href="<?php echo RUTA_PUBLIC; ?>/bibliotecaController">PORTADA</a>
                </li>
                <li class="nav-item">
                    <a id="catalogo" class="nav-link" href="<?php echo RUTA_PUBLIC; ?>/bibliotecaController/catalogo">CATÁLOGO</a>
                </li>
